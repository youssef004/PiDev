...
public class Plant {
    ...
    public Plant(int IdPlant, String NamePlant, String TypePlant, int QuantityPlant, String CategoryPlant, double PricePlant, String DescriptionPlant) {
    ...
    public String toString() {
        return "Plante{" + "IdPlant=" + IdPlant + ", NamePlant=" + NamePlant + ", TypePlant=" + TypePlant + ", QuantityPlant=" + QuantityPlant + ", CategoryPlant=" + CategoryPlant + ", PricePlant=" + PricePlant + ", DescriptionPlant=" + DescriptionPlant + '}';
    }
