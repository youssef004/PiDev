...
public class User {
    ...
    public User(int Cin, String LasteName, String FirstName, String Email, String Address, int Number, String Login, String Mdp, String Country, String City, int CodePostal) {
        this.Cin = Cin;
    ...
    public User(int Cin, String LasteName, String FirstName, String Email, String Address, int Number, String Login, String Mdp) {
        this.Cin = Cin;
        this.LasteName = LasteName;
        this.FirstName = FirstName;
        this.Email = Email;
