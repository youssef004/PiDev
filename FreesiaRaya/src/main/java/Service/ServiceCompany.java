...
public class ServiceCompany {
  ...
  public void  modifierCompany(int IdCompany, String NameCompany,String EmailCompany,String PasswordCompany,int NumberCompany,String AddressCompany ) throws ParseException{
        ...
        try {
            ...
            int nbre=st.executeUpdate("update company set EmailCompany='"+EmailCompany+"',PasswordCompany='"+PasswordCompany+"',NumberCompany='"+NumberCompany+"',AddressCompany='"+AddressCompany+"' where NameCompany='"+NameCompany+"'");
